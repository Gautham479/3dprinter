          ...
          {selectedFile ? (
            <div className="animate-in fade-in zoom-in duration-300">
              ...
              <p className="text-xs text-primary-500 mt-3 flex items-center justify-center gap-1">
                <span className="w-1.5 h-1.5 rounded-sm bg-primary-500"></span>
                Includes material & processing
              </p>
            </div>
          ) : (
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-primary-500/10 text-primary-500 rounded-sm flex items-center justify-center mb-4">
                <UploadCloud size={24} />
              </div>
